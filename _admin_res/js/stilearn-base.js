...
try {
    ...
    $(window).load(function () {
        setTimeout(function () {
            ...
            if(sessionStorage.themes == ''){
                $('#style-base').attr('href', '/_admin_res/css/stilearn.css');
                $('#style-responsive').attr('href', '/_admin_res/css/stilearn-responsive.css');
                $('#style-helper').attr('href', '/_admin_res/css/stilearn-helper.css');
                $('#style-calendar').attr('href', '/_admin_res/css/fullcalendar.css');
            }
            else{
                themes = sessionStorage.themes;
                theme_mode = sessionStorage.theme_mode;

                $('#style-base').attr('href', '/_admin_res/css/themes/'+themes+'/stilearn.css');
                $('#style-responsive').attr('href', '/_admin_res/css/themes/'+themes+'/stilearn-responsive.css');
                $('#style-helper').attr('href', '/_admin_res/css/themes/'+themes+'/stilearn-helper.css');
                $('#style-calendar').attr('href', '/_admin_res/css/themes/'+themes+'/fullcalendar.css');
    ...
    $('.themes-changer').click(function(e){
        ...
        if(data_themes == ''){
            ...
            $('#style-base').attr('href', '/_admin_res/css/themes/'+data_themes+'/stilearn.css');
            $('#style-responsive').attr('href', '/_admin_res/css/themes/'+data_themes+'/stilearn-responsive.css');
            $('#style-helper').attr('href', '/_admin_res/css/themes/'+data_themes+'/stilearn-helper.css');
            $('#style-calendar').attr('href', '/_admin_res/css/themes/'+data_themes+'/fullcalendar.css');
        }
