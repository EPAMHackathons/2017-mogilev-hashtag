						...
						{section name=i loop=$images}
							<tr>
								<td nowrap>
									...
									<a href="/_admin/album_images.php?act=edit&id={$images[i].id}{csrf_token}&item_id={$item.id}" title="Редактировать изображение" ><i class="icon-edit"></i></a>
								</td>
								<td>
									<a href="/images/album_images/{$images[i].img_fname}" rel="pretty"><img src="/images/album_images/th-{$images[i].img_fname}" /></a>
								</td>
							</tr>
						{/section}
						</tbody>
