		...
		<form method="post" class="form-validate form-horizontal form-alex" >
			...
			<fieldset>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="grd-white" name="password" id="password" value="{$item.password|escape}" required>
															</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="grd-white" name="public_key" id="public_key" value="{$item.public_key|escape}" required>
															</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="grd-white" name="private_key" id="private_key" value="{$item.private_key|escape}" required>
															</div>
						</div>
